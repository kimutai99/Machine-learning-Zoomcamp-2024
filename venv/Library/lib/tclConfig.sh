...
# installed.
TCL_PREFIX='D:/Machine-Learning-Zoomcamp 2024/venv\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='D:/Machine-Learning-Zoomcamp 2024/venv\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='D:/Machine-Learning-Zoomcamp 2024/venv\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-ID:/Machine-Learning-Zoomcamp 2024/venv\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LD:/Machine-Learning-Zoomcamp 2024/venv\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='D:/Machine-Learning-Zoomcamp 2024/venv\Library\lib\tclstub86.lib'
